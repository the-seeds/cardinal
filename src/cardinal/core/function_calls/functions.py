...
GET_RIVER_ENVIRONMENT = FunctionAvailable(function={
    ...
    'parameters': {
        ...
        'properties': {
            ...
            "location": {
                "type": "string",
                "description": "the location of the river environment to be queried"
            },
        },
...
GET_ENVIRONMENT_AIR = FunctionAvailable(function={
    ...
    "parameters": {
            ...
            "properties": {
                "location": {
                    "type": "string",
                    "description": "the location of the environment air to be queried"
                }
            },
        "required": ["location"]
    }
